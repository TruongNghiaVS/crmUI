        ...
        if (response.success == true) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                  ...
                  link.href = 'http://192.168.1.141:8888/api/reportCrm/dowloadFile?pathFile='+ response.pathFile;
...
const exportDataReport = () => {
  ...
  const deleteEmploy = (idEmp) => {
    ...
    Services.delete(
      ConstantData.URL_Employee_Delete,
      ...
      <div className="box-tbl">
        ...
        <div className="search-feature leftLayout">
          ...
          <div className="search-feature">
            ...
            {isAdmin ? (
              <button className="btn-search" onClick={exportData}>
                Xuất file
              </button>
            ) : (
              <></>
