...
import EmployeeService from '../../services/ViewRecordingService';
...
const User = () => {
    ...
    useEffect(() => {
        ...
        if (!isInit) {
            ...
            document.title = "Danh sách lượt xem";
    ...
    return (
        ...
        <div className="user">
          ...
          />
                ...
                <Table theadData={DataJson.theadReportViewRecordingOVerview} dataDraw={dataEmployee} handleDelete={handleDeleteEmpl} handleViewById={handleViewById} handleUpdateById={handleUpdateById} tbodyData={DataJson.tbodyDataUser} tblClass="tbl-custom-data" />
