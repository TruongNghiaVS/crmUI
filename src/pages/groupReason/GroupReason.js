    ...
    return (
        <div className="user">
            <div className='box-tbl'>
                ...
                <Table theadData={ DataJson.theadDataGroupReason } dataDraw={dataEmployee} handleDelete = {handleDeleteEmpl} handleViewById = {handleViewById} handleUpdateById = {handleUpdateById} tbodyData={ DataJson.tbodyDataUser } tblClass="tbl-custom-data" />
