    ...
    return (
        <div className="user">
          ...
          />
                ...
                <Table theadData={DataJson.theadReportViewRecording} dataDraw={dataEmployee} handleDelete={handleDeleteEmpl} handleViewById={handleViewById} handleUpdateById={handleUpdateById} tbodyData={DataJson.tbodyDataUser} tblClass="tbl-custom-data" />
