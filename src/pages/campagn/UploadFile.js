...
const UploadFile = (props) => {
    ...
    const [id , setid]=useState("");
     ...
     const UpdateData = () => {
        ...
        fetch('http://192.168.1.141:8888/api/campagn/importDataFile', {
            method: 'POST',
            body: data
        })
        .then((response) =>
     ...
     const UploadFileServer = () => {
        ...
        data.append('fileData', file)
        data.append('id', props.idPass);
        fetch('http://192.168.1.141:8888/api/campagn/importDataById', {
            method: 'POST',
            body: data
        })
        .then((response) =>
    ...
    return (
        <div className="model">
            ...
            {/* <button className="btn-model btn-add" onClick= {UpdateData}>Cập nhật dữ liệu </button> */}
                 <button className="btn-model btn-add" onClick= {UploadFileServer}>Import hoặc cập nhật </button>
