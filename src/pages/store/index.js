   ...
   const getAllPackage = ()=> {
    ...
    const getDataEmployee = (PackageKey ='')=> {
         ...
         let bodySearch = {
          ...
          EmployeeService.GetAll(ConstantData.URL_store_GetALl, ConstantData.HEADERS, bodySearch, (response) => {
                if (response.statusCode === 200) {
...
<Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
   ...
   />
                ...
                <Table theadData={ DataJson.theadDataStore2 } dataDraw={dataEmployee} handleDelete = {handleDeleteEmpl} handleViewById = {handleViewById} handleUpdateById = {handleUpdateById} tbodyData={ DataJson.tbodyDataUser } tblClass="tbl-custom-data" />
